    ...
    return (
      <div className="flex flex-col items-center justify-center h-full text-center px-4">
        ...
        <button
          onClick={onRefresh}
          disabled={isLoading}
          className="flex items-center gap-2 bg-[#FF6B35] text-white px-6 py-3 rounded-full font-semibold hover:bg-[#e55a2b] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
  ...
  return (
    <div className="relative w-full max-w-md mx-auto h-[500px]">
      ...
      <div className="absolute -bottom-20 left-0 right-0 flex justify-center gap-6">
        <button
          onClick={handleNope}
          className="w-16 h-16 rounded-full bg-white shadow-lg flex items-center justify-center text-red-500 hover:bg-red-50 transition-colors border-2 border-red-200"
        ...
        <button
          onClick={handleLike}
          className="w-16 h-16 rounded-full bg-white shadow-lg flex items-center justify-center text-green-500 hover:bg-green-50 transition-colors border-2 border-green-200"
          disabled={!cards.length}
        >
